...
Although this approach is proposed to take the advantage of the dataset (to fine-tune visual semantic scorer), we also investigate the use of out-of-the-box tools to estimate the relatedness score between the short text (i.e. caption)  and its environmental visual context (visual classifier). 
